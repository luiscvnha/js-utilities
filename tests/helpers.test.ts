...
describe("Testing helpers", () => {
  ...
  describe("numbers", () => {
    ...
    test("toIntegerOrInfinity", () => {
      ...
      expect(toIntegerOrInfinity(10.2)).toBe(10);
      expect(toIntegerOrInfinity(10.5)).toBe(10);
      expect(toIntegerOrInfinity(10.8)).toBe(10);
      expect(toIntegerOrInfinity(-10.2)).toBe(-10);
      expect(toIntegerOrInfinity(-10.5)).toBe(-10);
      expect(toIntegerOrInfinity(-10.8)).toBe(-10);
    });

    test("toAbsoluteIndex", () => {
      expect(toAbsoluteIndex(-7, 5)).toBe(0);
      expect(toAbsoluteIndex(-6, 5)).toBe(0);
      expect(toAbsoluteIndex(-5, 5)).toBe(0);
      expect(toAbsoluteIndex(-4, 5)).toBe(1);
      expect(toAbsoluteIndex(-3, 5)).toBe(2);
      expect(toAbsoluteIndex(-2, 5)).toBe(3);
      expect(toAbsoluteIndex(-1, 5)).toBe(4);
      expect(toAbsoluteIndex(0, 5)).toBe(0);
      expect(toAbsoluteIndex(1, 5)).toBe(1);
      expect(toAbsoluteIndex(2, 5)).toBe(2);
      expect(toAbsoluteIndex(3, 5)).toBe(3);
      expect(toAbsoluteIndex(4, 5)).toBe(4);
      expect(toAbsoluteIndex(5, 5)).toBe(5);
      expect(toAbsoluteIndex(6, 5)).toBe(5);
      expect(toAbsoluteIndex(7, 5)).toBe(5);
    });
